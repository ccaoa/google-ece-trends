...
if __name__ == "__main__":
    ...
    def individual_appends(raw_data_dir: str = None):
        if not raw_data_dir:
            raw_data_dir = os.path.expanduser(r"~\NACCRRA\Research Team - Documents\Mapping\google_trends\gtrends_data\raw_data")

        tstfil = os.path.join(raw_data_dir,"eugene_time_20200214-20210214_20231214.csv")
        anothertestfil = os.path.join(raw_data_dir, "eugene_time_20200214-20210214_20231208.csv")
        vtines_list = [
            os.path.join(raw_data_dir, "valentines_dma_df_20200214-20210214_20231212.csv"),
            os.path.join(raw_data_dir, "valentines_dma_df_20200214-20210214_20231209.csv"),
        ]
        additional_vtines = [
            os.path.join(raw_data_dir, "valentines_dma_df_20200214-20210214_20231207.csv"),
            os.path.join(raw_data_dir, "valentines_dma_df_20200214-20210214_20231214.csv"),
        ]
        two_uoas = [
            os.path.join(raw_data_dir, "mn_time_20200214-20210214_20231208.csv"),
            os.path.join(raw_data_dir, "mn_time_20200214-20210214_20231206.csv"),
            os.path.join(raw_data_dir, "valentines_dma_df_20200214-20210214_20231204.csv"),
        ]
        # print(define_target_append_dataset(two_uoas[0]))
        epiphany = [os.path.join(raw_data_dir, f) for f in os.listdir(raw_data_dir) if f.endswith('.csv') and '20240106' in f]
